...
class TodoViewModel {
  ...
  var todosAnyPublisher: AnyPublisher<IdentifiedArrayOf<Todo>, Never> {
    _todos.publisher
      .eraseToAnyPublisher()
  }
...
class DemoSwiftUIViewController: BaseSwiftUIViewController {
...
class DemoSwiftUIView: BaseSwiftUIView {
...
class DemoTodoStatsView: BaseSwiftUIView {
